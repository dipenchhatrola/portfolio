            ...
            <div className="container">
                <div className="row">
                    ...
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        <h4 className="text-center text-primary">Atmiya University</h4>
                    ...
                    <div className="col-md-6 d-flex flex-column justify-content-center">
                        <h4 className="text-center text-primary">Shree GK Dholakiya School</h4>
                        <h5 className="text-center">HSC</h5>
                        <h6 className="text-center">2019</h6>
                        <h6 className="mb-5 text-center">70.20 PR</h6>
                        <h5 className="text-center">SSC</h5>
                        <h6 className="text-center">2017</h6>
                        <h6 className="mb-5 text-center">65.20 PR</h6>                            
                    </div>
                </div>
            </div>
        </div>
